...
const double ang_res_x = 0.2;
const double ang_res_y = 2.0;
const double ang_bottom = 15.0+0.1;
...
// const int Horizon_SCAN = 1800;
// const double ang_res_x = 0.2;
// const double ang_res_y = 0.33;
// const double ang_bottom = 25.0;
// const int ground_scan_id = 20;
// const double scan_period = 0.1;

// // HDL_32E
// const int N_SCAN = 32;
// const int Horizon_SCAN = 1800;
// const double ang_res_x = 360.0/double(Horizon_SCAN);
// const double ang_res_y = 41.33/double(N_SCAN-1);
// const double ang_bottom = 30.67;
// const int ground_scan_id = 20;
// const double scan_period = 0.1;
...
// const double ang_res_x = 360.0/double(Horizon_SCAN);
// const double ang_res_y = 26.9/double(N_SCAN-1);
// const double ang_bottom = 25.0;
// const int ground_scan_id = 30;
// const double scan_period = 0.1;
...
// const int Horizon_SCAN = 1800;
// const double ang_res_x = 0.2;
// const double ang_res_y = 0.3;
// const double ang_bottom = 25.0;
// const int ground_scan_id = 10;
// const double scan_period = 0.1;

// // OS1_16
// // Ouster users may need to uncomment line 111 in imageProjection.cpp
...
// const double ang_res_x = 360.0/double(Horizon_SCAN);
// const double ang_res_y = 33.2/double(N_SCAN-1);
...
//const double ang_res_y = 33.2/double(N_SCAN-1);
//const double ang_bottom = 16.6+0.1;
//const int ground_scan_id = 15;
//const double scan_period = 0.1;

// // LSLIDAR_C16 or RFANS_16M
// const int N_SCAN = 16;
...
const double sensor_mount_ang = 0.; // 向下为正，向上为负 / positive for downwards and negative for upwards

const double seg_alpha_x = ANGLE2RAD(ang_res_x);
const double seg_alpha_y = ANGLE2RAD(ang_res_y);
// 可以调调参数 / Can adjust parameters
const double seg_theta = 60.0/180.0*M_PI; // decrese this value may improve accuracy
...
const double nearest_feature_dist = 25.; // sqaured, 对应 5m / sqaured, correspond 5 m
...
LaserType laser_type = LaserType::VLP_16;
