...
В отдельном терминале одключиться к Husky по ssh. Активировать гриппер:
<pre><code>
<b>local$</b> cd catkin_ws/src/robotiq_2finger_grippers/robotiq_2f_gripper_control/launch
roslaunch robotiq_action_server.launch
</code></pre>
