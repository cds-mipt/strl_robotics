...
![Структура системы](assets/STRL_robotics.png)

## Модуль локализации и построения карты

Код для оценки визуальной, лидарной и колесной одометрии, комплексирования навигационных данных, а также локализации по заранее сохраненной карте размещен в папке [odometry](odometry) 

Код для построения и обновления карты проходимости по данным лидара размещен в папке [occupancy_grid_mapping](occupancy_grid_mapping) 

## Модуль распознавания объектов

Код для инстанс-сегментации объектов и оценке их 6Dof позы размещен в папке [3D_objects_detection](3D_objects_detection) 

## Модуль планирования пути мобильной платформы

Код для планирования пути мобильной платформы размещен в папке [planning](planning) 

## Модуль управления движением мобильной платформы

Код для управления движением мобильной платформы размещен в папке [control](control) 

## Модуль планирования и управления движением манипулятора

Код для планирования и управления движением манипулятором размещен в папке [manipulator](manipulator) 
...
[![Демонстрация работы робота по вызову лифта](https://img.youtube.com/vi/u5fdLFPKltY/0.jpg)](https://www.youtube.com/watch?v=u5fdLFPKltY)
...
![Координация действий при управлении роботом с манипулятором при вызове лифта](assets/rosnodes.png)


# Документация

[Структура фреймворка с описанием ROS-узлов в pdf](https://yadi.sk/i/YCP-PfHOuK9u6w)

**0. Системы координат робота** 
---
([Владислав Головин](https://github.com/nivolog))<br/>
...
---
([Андрей Криштопик](https://github.com/andrey1908))<br/>
...
---
([Андрей Криштопик](https://github.com/andrey1908) + [Линар Абдразаков](https://github.com/LinarAbdrazakov) + [Владислав Головин](https://github.com/nivolog))<br/>
...
---
([Линар Абдразаков](https://github.com/LinarAbdrazakov)) <br/>
...
[![Occupancy grid builder with map saving and loading](https://img.youtube.com/vi/S6nIUXKn29M/0.jpg)](https://www.youtube.com/watch?v=S6nIUXKn29M)
...
---
([Мухаммад Алхаддад](https://github.com/MuhammadAlhaddad))<br/>
...
---
([Константин Миронов](https://github.com/mironovconst))<br/>
...
---
([Сергей Линок](https://github.com/linukc))<br/>
